...
# Load the trained GoogleNet (InceptionV3) model
model = tf.keras.models.load_model(r"C:\Natan\Data Science\52025 - Adv computational learning and data analysis\Final Project\result\fine_tuned_googlenet.h5")
...
test_data = test_datagen.flow_from_directory(
    test_dir,
    target_size=(224, 224),  # Adjusted to match model input size
    batch_size=32,
...
plt.title(f"AUC-ROC Curve - GoogleNet (InceptionV3)\nWeighted F1-score: {f1:.4f}")  # Add F1-score to title
